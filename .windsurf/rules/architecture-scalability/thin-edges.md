...
description: "Thin hard-to-test edges: Views, controllers, and persistence adapters stay skinny; the testable policy is pulled inside the boundary where unit tests can exe…"
---
