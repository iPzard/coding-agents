...
description: "Dependency Rule: Source code dependencies point only inward, toward higher-level policies. Outer layers may name inner-layer types; inner layers must NOT nam…"
---
