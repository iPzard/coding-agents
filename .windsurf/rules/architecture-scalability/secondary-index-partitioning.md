...
description: "Secondary index partitioning: A local secondary index (one per partition) requires scatter/gather across all partitions on read — every query becomes O(parti…"
---
