...
description: "Partition key: Spread data and load evenly. A bad partition key creates hot spots — a single celebrity user, a timestamp prefix, a sequential id. Hashing avo…"
---
