...
description: "Three layers: Presentation, Domain, Persistence. Domain and Persistence must never depend on Presentation. Logic that runs identically under a CLI, a web req…"
---
