...
description: "Liskov Substitution Principle (LSP): Any subtype must be usable wherever its parent type is used. A subtype that throws \"not implemented\" on a parent method,…"
---
