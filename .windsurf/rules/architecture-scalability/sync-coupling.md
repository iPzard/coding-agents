...
description: "Sync coupling: Synchronous coupling kills availability. If Service A synchronously calls Service B to complete a request, A's availability ≤ B's availability…"
---
