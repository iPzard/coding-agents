...
description: "Replication semantics: - Single-leader — simple, all writes through one node; lag means reads from followers may be stale (read-your-writes anomalies)."
---
