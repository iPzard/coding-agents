...
description: "Service Layer: Sits over the domain and provides the use-case API. Transactions, security, and use-case orchestration go here. Controllers call the service l…"
---
